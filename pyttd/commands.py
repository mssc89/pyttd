...
class CommandPacket:
    ...
    def encode_parameters(self) -> bytes:
        ...
        if self.command_id == Commands.BUILD_RAILROAD_TRACK:
            ...
            return struct.pack('<BBBL', 0, 255, 0, 0)  # CCA_NEW, INVALID_COMPANY, CRR_NONE, INVALID_CLIENT_ID
        else:
...
class CommandBuilder:
    ...
    @staticmethod
    def build_rail(start_tile: int, end_tile: int, rail_type: RailType = RailType.RAIL, 
                   company: int = 1) -> CommandPacket:
    ...
    @staticmethod
    def build_single_rail(tile: int, track: Track, rail_type: RailType = RailType.RAIL,
                         company: int = 1) -> CommandPacket:
        ...
        return CommandPacket(
            company=company,
            command_id=Commands.BUILD_SINGLE_RAIL,
            p1=tile,
            p2=p2,
            tile=tile
        )
    ...
    @staticmethod
    def build_rail_station(tile: int, rail_type: RailType = RailType.RAIL, 
                          orientation: int = 0, num_platforms: int = 1, 
                          platform_length: int = 1, station_class: int = 0,
                          station_type: int = 0, company: int = 1) -> CommandPacket:
        ...
        return CommandPacket(
            company=company,
            command_id=Commands.BUILD_RAIL_STATION,
            p1=p1,
            p2=p2,
            tile=tile
        )
    ...
    @staticmethod
    def build_train_depot(tile: int, direction: int, rail_type: RailType = RailType.RAIL,
                         company: int = 1) -> CommandPacket:
        """Build a train depot"""
        # p1 = rail_type
        # p2 = direction
    ...
    def start_stop_vehicle(vehicle_id: int, company: int = 1) -> CommandPacket:
        ...
        return CommandPacket(
            company=company,
            command_id=Commands.START_STOP_VEHICLE,
            p1=vehicle_id,
            p2=0
        )
    ...
    def build_vehicle(depot_tile: int, engine_id: int, company: int = 1) -> CommandPacket:
        ...
        return CommandPacket(
            company=company,
            command_id=Commands.BUILD_VEHICLE,
            p1=engine_id,
            p2=0,
            tile=depot_tile
        )
    ...
    def rename_company(new_name: str, company: int = 1) -> CommandPacket:
        ...
        return CommandPacket(
            company=company,
            command_id=Commands.RENAME_COMPANY,
            p1=0,
            p2=0,
            text=new_name
        )
    ...
    def rename_president(new_name: str, company: int = 1) -> CommandPacket:
        ...
        return CommandPacket(
            company=company,
            command_id=Commands.RENAME_PRESIDENT,
            p1=0,
            p2=0,
            text=new_name
        )
    ...
    @staticmethod
    def set_company_colour(scheme: int, primary: bool, colour: int, company: int = 1) -> CommandPacket:
    ...
    def clear_tile(tile: int, company: int = 1) -> CommandPacket:
        ...
        return CommandPacket(
            company=company,
            command_id=Commands.LANDSCAPE_CLEAR,
            p1=0,
            p2=0,
            tile=tile
        )